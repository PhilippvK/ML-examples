...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--testing_percentage", type=int, default=10, help="What percentage of wavs to use as a test set."
    )
    parser.add_argument(
        "--validation_percentage", type=int, default=10, help="What percentage of wavs to use as a validation set."
    )
    parser.add_argument(
        "--sample_rate",
        type=int,
    ...
    parser.add_argument(
        "--eval_step_interval", type=int, default=400, help="How often to evaluate the training results."
    )
    parser.add_argument(
        "--learning_rate", type=str, default="0.001,0.0001", help="How large a learning rate to use when training."
    )
    parser.add_argument(
        "--batch_size",
        type=int,
    ...
    parser.add_argument(
        "--summaries_dir", type=str, default="/tmp/retrain_logs", help="Where to save summary logs for TensorBoard."
    )
    parser.add_argument(
        "--wanted_words",
        type=str,
